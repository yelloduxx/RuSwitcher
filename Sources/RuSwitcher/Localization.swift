...
enum L10n {
    ...
    private static let strings: [String: [String: String]] = [
        ...
        "el": [
            ...
            "settings.checkUpdates.hint": "Συνδέεται στο GitHub σε κάθε εκκίνηση για αναζήτηση νέων εκδόσεων.",
        ...
        "bg": [
            ...
            "settings.checkUpdates.hint": "Свързва се с GitHub при всяко стартиране, за да търси нови версии.",
        ...
        "hy": [
            ...
            "settings.checkUpdates.hint": "Ամեն գործարկման ժամանակ միանում է GitHub-ին՝ նոր տարբերակներ փնտրելու համար.",
        ...
        "ka": [
            ...
            "settings.checkUpdates.hint": "ყოველ გაშვებაზე უკავშირდება GitHub-ს ახალი ვერსიების მოსაძებნად.",
